...
export const SURAS: EzberSura[] = [
  {
    ...
    segments: [
      seg("b", "بِسْمِ اللّٰهِ الرَّحْمٰنِ الرَّحٖيمِ", "Bismillâhirrahmânirrahîm"),
  ...
  },
  {
    ...
    segments: [
      ...
      seg("1b", "رَبِّ الْعَالَمٖينَ", "rabbil âlemîn"),
      seg("2a", "اَلرَّحْمٰنِ الرَّحٖيمِ", "Errahmânirrahîm"),
      seg("3a", "مَالِكِ يَوْمِ الدّٖينِ", "Mâliki yevmiddîn"),
      seg("4a", "اِيَّاكَ نَعْبُدُ", "İyyâke na'büdü"),
      seg("4b", "وَاِيَّاكَ نَسْتَعٖينُ", "ve iyyâke neste'în"),
      seg("5a", "اِهْدِنَا الصِّرَاطَ الْمُسْتَقٖيمَ", "İhdinessırâtal müstekîm"),
      seg("6a", "صِرَاطَ الَّذٖينَ اَنْعَمْتَ عَلَيْهِمْ", "Sırâtallezîne en'amte aleyhim"),
      seg("7a", "غَيْرِ الْمَغْضُوبِ عَلَيْهِمْ", "Gayril mağdûbi aleyhim"),
      seg("7b", "وَلَا الضَّٓالّٖينَ", "ve leddâllîn"),
    ],
  },
  {
    id: "felak",
  ...
  },
  {
    ...
    segments: [
      ...
      seg("5a", "اَلَّذٖي يُوَسْوِسُ", "Ellezî yüvesvisü"),
      seg("5b", "فٖي صُدُورِ النَّاسِ", "fî sudûrinnâs"),
