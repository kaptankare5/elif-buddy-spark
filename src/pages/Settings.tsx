        ...
        <div className="space-y-3">
          ...
          <div className="rounded-2xl bg-card p-4 shadow-card border-2 border-border/40">
            ...
            <p className="text-[11px] text-muted-foreground mt-2 leading-snug">
              Süper modda sadece şu oyunlar gösterilir: Tren Sörfü, Elif Ba Macerası, Elifbâ Partisi, Yılan, Uzay, Balon, Kutu Boşalt, Uçan Kuş, Hızlı Quiz. İpucu halkası yalnız seviye 1'de görünür.
            </p>
          </div>
