        ...
        <>
          ...
          {glifFlash && (
            <div className="pointer-events-none absolute inset-x-0 top-1/2 z-30 flex -translate-y-1/2 justify-center">
              ...
              {/* ⚠️ leading 1.35 gliflerin noktasını/kesresini yuvarlağın
                  DIŞINA taşırıyordu (kullanıcı gördü); Arapça glif taban
                  çizgisinin altına da üstüne de taşar → 1.7 şart.
                  Siyah ince çerçeve: şıkların etrafındaki gibi. */}
