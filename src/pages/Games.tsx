...
const GAMES: GameDef[] = [
  ...
  { id: "party", title: "Elifbâ Partisi", emoji: "🎉", color: "from-fuchsia-500 to-amber-400", desc: "3B engel parkuru: çekiçten kaç, doğru kapıdan geç", diff: "zor" },
  { id: "kart", title: "Elifbâ Yarışı", emoji: "🏎️", color: "from-rose-500 to-sky-400", desc: "3B kart yarışı: virajları al, doğru kapıdan geç", diff: "zor" },
